          ...
          >
            ...
            <div className="p-4 flex flex-col gap-2 relative z-10">
              ...
              <p className="text-gray-600 font-bold text-lg">
                Rent Per Day{" "}
                <span className="text-[#09764c]">${car.rentPerDay}</span>
              </p>
              ...
              >
                <Link to={`/car-details/${car._id}`} className="bg-[#09764c] hover:bg-green-600 text-white font-semibold py-2 px-6 rounded-full shadow-lg transition-all duration-300">
                  View Details
                </Link>
              </motion.div>
            </div>
