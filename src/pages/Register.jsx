...
const Register = () => {
  ...
  return (
    <div className="h-full flex items-center justify-center bg-gradient-to-r from-indigo-50 via-purple-50 to-blue-50 px-4">
      <div className="max-w-md my-10 bg-white rounded-3xl shadow-2xl p-10 space-y-3 border border-white/30 backdrop-blur-sm">
        <h1 className="text-4xl font-extrabold text-gray-800 text-center">
          Create Account
        </h1>
        <p className="text-center text-gray-500">
          Join Smart Deals & start selling or buying your favorite products!
        </p>
