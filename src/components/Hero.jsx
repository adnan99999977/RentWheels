...
const Hero = () => {
  return (
    <div className="relative bg-[url('/bg.jpg')] bg-cover bg-center h-[560px] flex flex-col justify-center items-center text-center px-4 overflow-hidden">
      ...
      >
        ...
        <motion.p
          ...
          className="text-gray-300 max-w-xl text-base md:text-lg mb-6 leading-8"
        >
          Seamless car rentals, flexible bookings, and 24/7 support for you need
          for a smooth journey. Hit the road effortlessly and make every trip
          memorable.
        </motion.p>
